...
// ⚠️ OTP model is no longer needed for registration (commented out)
// import { OTP } from '../models/OTP.model'
import { JWTService } from '../services/jwt.service'
// ⚠️ Temporarily disable email service to avoid timeout
// import { emailService } from '../services/email.service'
import { AppError } from '../middleware/error.middleware'
import { logger } from '../utils/logger'
// crypto is still needed if you later use it, but not used now
...
export class AuthController {
  static async register(req: Request, res: Response) {
    ...
    // This was causing the registration to timeout because the email service
    // is not properly configured. Uncomment and configure your email service
    // (SendGrid, Nodemailer, etc.) when ready.
    // ============================================
    /*
    try {
    ...
    */
    console.log('ℹ️ OTP sending skipped (email service not configured)')
    
    // ✅ Success response - now returns quickly
  ...
  // ============================================
  // All other methods (login, logout, refresh, etc.) remain unchanged
  // ============================================
  ...
  static async forgotPassword(req: Request, res: Response) {
    ...
    try {
      ...
      // For now, we won't send email; we'll just return success.
      // You can later add the reset token logic and email sending.
      console.log('ℹ️ Password reset requested but email sending disabled.')
